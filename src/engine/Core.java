        ...
        do {
            ...
            switch (returnCode) {
                ...
                case 2:
                    ...
                    LOGGER.info("Starting " + WIDTH + "x" + HEIGHT
                            + " title screen at " + FPS + " fps.");
                    playerAmount = frame.setScreen(currentScreen);
                    returnCode = 100;
                    LOGGER.info("Closing title screen.");
                    break;
                case 100:
                    // Play & Level Screen
                    // LevelScreen에서 플레이어 숫자별, 난이도별의 조합으로 returnCode를 핸들링해줘야햡니다.
                    // 참고: playerAmount에 플레이어 숫자 정보가 할당돼있습니다.
                    currentScreen = new LevelScreen(width, height, FPS);
                    LOGGER.info("Starting " + WIDTH + "x" + HEIGHT
                            + " setting screen at " + FPS + " fps.");
                    returnCode = frame.setScreen(currentScreen);
                    LOGGER.info("Closing level setting screen.");
                    break;
                ...
                case 400080:
                    ...
                    // practice finished. Return to main menu.
                    returnCode = 1;
